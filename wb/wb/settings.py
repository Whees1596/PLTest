...
SECRET_KEY = 'django-insecure-(77*bhhv%7ou)!g0%v6*yo13*9l9o&3(@mf@6960o@q7zy6(3p'
...
DATABASES = {
    'default': {
        ...
        'NAME': f'{CONFIG["database"]["dbname"]}',
        'USER': f'{CONFIG["database"]["username"]}',
